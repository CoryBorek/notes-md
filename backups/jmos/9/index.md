...
```c int main(struct multiboot *mboot_ptr, u32int initial_stack)
{
   initial_esp = initial_stack;
...
Full source code is available [here](https://web.archive.org/web/20220628181238/http://www.jamesmolloy.co.uk/tutorial_html/multitasking.tar.gz).
