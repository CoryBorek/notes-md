...
A solution presents itself if you know how the sti and cli instructions work - they just set the 'IF' flag in EFLAGS. [Wikipedia](http://en.wikipedia.org/wiki/EFLAGS) tells us that the IF flag has a mask of 0x200, so what you could do, is insert these lines just after the 'pushf' in the asm above:
...
Full source code and image file is available [here](https://web.archive.org/web/20220628181238/http://www.jamesmolloy.co.uk/tutorial_html/user_mode.tar.gz).
