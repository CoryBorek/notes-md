...
## 1.2. Compiling
The examples in this tutorial should compile successfully with the GNU toolchain (gcc, ld, gas, etc). The assembly examples are written in intel syntax, which is (my personal opinion) a much more human-readable syntax than the AT&T syntax that GNU AS uses. To assemble these, you will need the [Netwide Assembler](https://web.archive.org/web/20221024033112/http://nasm.sourceforge.net/).

This tutorial is not a bootloader tutorial. We will be using [GRUB](https://web.archive.org/web/20221024033112/http://www.gnu.org/software/grub) to load our kernel. To do this, we need a floppy disk image with GRUB preloaded onto it. There are t[tutorials](https://web.archive.org/web/20221024033112/http://www.jamesmolloy.co.uk/tutorial_html/tutorials) to do this, but, happily, I have made a standard image, which can be found [here](https://web.archive.org/web/20221024033112/http://www.jamesmolloy.co.uk/tutorial_html/floppy.img). This goes in your 'tutorial' (or whatever you named it) directory.
